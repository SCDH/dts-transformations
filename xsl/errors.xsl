...
<xsl:package name="https://scdh.github.io/dts-transformations/xsl/errors.xsl"
  ...
  xmlns:http="https://www.rfc-editor.org/rfc/rfc9110.html" exclude-result-prefixes="#all"
  version="3.0">

  <xsl:param name="dts:http400" as="xs:string" static="true" select="'http:ERR400'"/>

  <xsl:param name="dts:http404" as="xs:string" static="true" select="'http:ERR404'"/>
